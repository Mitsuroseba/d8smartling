...
class CheckStatusQueueManagerTest extends \PHPUnit_Framework_TestCase {
  ...
  public function testAdd() {
    $this->assertEquals(TRUE, TRUE, 'Path traversal test for: "dir1/dir2/dir3/dir4"');
  }
  ...
  public function testExecuteNotConfigured() {
    ...
    $manager = new QueueManager\CheckStatusQueueManager($this->api_wrapper, $this->smartling_submission_wrapper, $this->submissions_collection, $this->queue_download, $this->log, $this->smartling_utils);
    $manager->execute(1);
  }
